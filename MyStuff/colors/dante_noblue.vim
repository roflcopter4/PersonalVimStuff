...
" Updated: "Wed, 11 Nov 2015 04:59 PM
...
let g:colors_name = "dante_noblue"

" General colors
hi Normal	ctermfg=gray guifg=peachpuff3 guibg=black
hi Directory	term=bold ctermfg=cyan guifg=royalblue
hi ErrorMsg	term=standout ctermfg=white  guifg=white guibg=red3
...
hi Search	term=reverse ctermfg=black  guifg=gray10 guibg=gold2
hi Visual	term=bold,reverse cterm=bold,reverse ctermfg=gray  gui=bold,reverse guifg=gray40 guibg=black
...
hi WildMenu	term=standout ctermfg=black  guifg=black guibg=gold2
hi Folded	term=standout ctermfg=cyan  guifg=royalblue1 guibg=white
hi FoldColumn	term=standout ctermfg=cyan  guifg=royalblue3 guibg=white
hi DiffAdd	term=bold  guibg=royalblue2
hi DiffChange	term=bold  guibg=maroon
hi DiffDelete	term=bold cterm=bold ctermfg=lightblue  gui=bold guifg=lightblue guifg=blue4
hi DiffText	term=reverse cterm=bold  gui=bold guibg=red3
...
" syntax hi colors
hi Comment	term=bold ctermfg=darkcyan guifg=blue4
hi PreProc	ctermfg=white guifg=dodgerblue4
...
hi Error	term=reverse ctermfg=gray  guifg=gray guibg=red3
hi Todo		term=standout ctermfg=black  gui=bold guifg=gray10 guibg=yellow4
