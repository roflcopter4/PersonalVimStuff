...
let g:colors_name = 'MyNova'

set background=dark
let s:molokai_red = '#F92672'
...
call s:HL('IncSearch'      , s:black_        , s:beige_        , s:none)
...
call s:HL('Search'         , s:foreground    , s:selection     , '')
...
call s:HL('Conditional'    , s:deep_orange   , ''              , s:bold)
...
call s:HL('Keyword'        , s:light_green   , ''              , '')
...
call s:HL('Repeat'         , s:deep_orange   , ''              , s:bold)
call s:HL('Special'        , s:cyan          , ''              , s:italic)
"call s:HL("SpecialChar"    , s:orange        , ''              , s:bold)
call s:HL('SpecialChar'    , s:molokai_red   , ''              , s:none)
...
call s:HL('Type'           , s:molokai_red   , ''              , s:none)
