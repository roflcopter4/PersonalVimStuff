...
let g:colors_name="NoBold_myMolokai1"
...
call s:HL("Conditional"    , s:bright_pink     , ''                , s:none)
call s:HL("Constant"       , s:light_purple    , ''                , s:none)
call s:HL("Cursor"         , s:black_          , s:cursor          , s:none)
call s:HL("Debug"          , s:debug_grey      , ''                , s:none)
...
call s:HL("Directory"      , s:lime_           , ''                , s:none)
"call s:HL("Error"         , s:diff_grey       , s:very_dark_red   , s:none)
call s:HL("Error"          , s:normal          , s:salmon_         , s:none)
call s:HL("ErrorMsg"       , s:bright_pink     , s:lighter_bg      , s:none)
call s:HL("Exception"      , s:lime_           , ''                , s:none)
...
call s:HL("Keyword"        , s:bright_pink     , ''                , s:none)
...
call s:HL("PreCondit"      , s:lime_           , ''                , s:none)
call s:HL("PreProc"        , s:lime_           , ''                , s:none)
call s:HL("Question"       , s:cyan_           , ''                , s:none)
call s:HL("Repeat"         , s:bright_pink     , ''                , s:none)
...
call s:HL("Statement"      , s:bright_pink     , ''                , s:none)
