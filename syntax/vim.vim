...
syn match	vimPatSep2	contained	"|"
syn region	vimPatSepZone	oneline   contained   matchgroup=vimPatSepZ start="\\v.*\zs%\ze(" skip="\\\\" end=")\|[^\]['"]"	contains=@vimStringGroup,vimPatSep2,@vimSubstSpecChars
syn region	vimPatRegion	contained transparent matchgroup=vimPatSepR start="\\v.*\zs[z%](" end=")" contains=@vimSubstList,vimPatSep2 oneline
syn region	vimPatSepZone	oneline   contained   matchgroup=vimPatSepZ start="\\v.*\zs\ze(" skip="\\\\" end=")\|[^\]['"]"	contains=@vimStringGroup,vimPatSep2,@vimSubstSpecChars
syn region	vimPatRegion	contained transparent matchgroup=vimPatSepR start="\\v.*\zs(" end=")" contains=@vimSubstList,vimPatSep2 oneline


" " Very Magic: {{{2
" " ==========
" syn cluster	vimSubstList2	contains=vimPatSep2,vimPatRegion2,vimPatSepErr2,vimSubstTwoBS2,vimSubstRange2,vimNotation
" " syn region	vimVeryMagic	start=""
" " syn region	vimSubstPat2	contained matchgroup=vimSubstDelim2 start="\z([^a-zA-Z( \t[\]&]\)\\v"rs=s+1 skip="\\\\\|\\\z1" end="\z1"re=e-1,me=e-1 contains=@vimSubstList nextgroup=vimSubstRep4 oneline
" " syn match	vimPatSep2	contained "|"
" 
" syn region	vimEscapeBrace2	oneline   contained transparent start="[^\\]\%(\\\\\)*\[\zs\^\=\]\=" skip="\\\\\|\\\]" end="]"me=e-1
" " syn match	vimPatSepErr2	contained	"\\v.*\zs)"
" " syn match	vimPatSep2	contained	"\\v.*\zs|"
" " syn match	vimPatSepErr2	contained	")"
" syn match	vimPatSep2	contained	"\\v.*\zs|"
" syn region	vimPatSepZone2	oneline   contained   matchgroup=vimPatSepZ start="\\v.*\zs%\ze(" skip="\\\\" end=")\|[^\]['"]"	contains=@vimStringGroup2
" syn region	vimPatRegion2	contained transparent matchgroup=vimPatSepR start="\\v.*\zs[z%](" end=")"	contains=@vimSubstList2 oneline
" syn match	vimNotPatSep2	contained	"\\\\"
" 
" 
" syn cluster	vimSubstList2	contains=vimPatSep2,vimPatRegion2,vimPatSepErr2,vimSubstTwoBS2,vimSubstRange2,vimNotation
" syn cluster	vimSubstRepList2	contains=vimSubstSubstr2,vimSubstTwoBS2,vimNotation2
" " syn cluster	vimSubstList2	add=vimCollection
" syn match	vimSubst2	"\%(:\+\s*\|^\s*\||\s*\)\<\%(\<s\%[ubstitute]\>\|\<sm\%[agic]\>\|\<sno\%[magic]\>\)[:#[:alpha:]]\@!" nextgroup=vimSubstPat2
" syn match	vimSubst2	"\%(^\|[^\\]\)\<s\%[ubstitute]\>[:#[:alpha:]]\@!"	nextgroup=vimSubstPat2 contained
" syn match	vimSubst2	"/\zs\<s\%[ubstitute]\>\ze/"		nextgroup=vimSubstPat2
" syn match	vimSubst2	"\%(:\+\s*\|^\s*\)s\ze#.\{-}#.\{-}#"	nextgroup=vimSubstPat2
" syn match	vimSubst12       contained	"\<s\%[ubstitute]\>"	nextgroup=vimSubstPat2
" syn region	vimSubstPat2     contained	matchgroup=vimSubstDelim2 start="\z([^a-zA-Z( \t[\]&]\)\\v"rs=s+1 skip="\\\\\|\\\z1" end="\z1"re=e-1,me=e-1	 contains=@vimSubstList2	nextgroup=vimSubstRep42	oneline
" syn region	vimSubstRep42    contained	matchgroup=vimSubstDelim2 start="\z(.\)\\v" skip="\\\\\|\\\z1" end="\z1" matchgroup=vimNotation end="<[cC][rR]>" contains=@vimSubstRepList2	nextgroup=vimSubstFlagErr2	oneline
" syn region	vimCollection2   contained transparent	start="\\\@<!\[" skip="\\\[" end="\]"	contains=vimCollClass2
" syn match	vimCollClassErr2 contained	"\[:.\{-\}:\]"
" syn match	vimCollClass2    contained transparent	"\[:\%(alnum\|alpha\|blank\|cntrl\|digit\|graph\|lower\|print\|punct\|space\|upper\|xdigit\|return\|tab\|escape\|backspace\):\]"
" syn match	vimSubstSubstr2  contained	"\\z\=\d"
" syn match	vimSubstTwoBS2   contained	"\\\\"
" syn match	vimSubstFlagErr2 contained	"[^< \t\r|]\+" contains=vimSubstFlags2
" syn match	vimSubstFlags2   contained	"[&cegiIpr]\+"
" 
" 
"  hi def link vimNotPatSep2	vimString
"  hi def link vimPatSepErr2	vimPatSep
"  hi def link vimPatSepR2	vimPatSep
"  hi def link vimPatSep2	SpecialChar
"  hi def link vimPatSepZone2	vimString
"  hi def link vimPatSepZ2	vimPatSep
"  hi def link vimPattern2	Type
"  hi def link vimSep2	Delimiter
"  hi def link vimSubst12	vimSubst
"  hi def link vimSubstDelim2	Delimiter
"  hi def link vimSubstFlags2	Special
"  hi def link vimSubstSubstr2	SpecialChar
"  hi def link vimSubstTwoBS2	vimString
"  hi def link vimSubst2	vimCommand
" 
" syn cluster	vimSynRegPatGroup2  contains=vimPatSep2,vimNotPatSep2,vimSynPatRange2,vimSynNotPatRange2,vimSubstSubstr2,vimPatRegion2,vimPatSepErr2
" syn cluster	vimSynRegGroup2	  contains=vimSynContains2,vimSynNextgroup2,vimSynRegOpt2,vimSynReg2,vimSynMtchGrp2
" syn keyword	vimSynType2	  contained	region	skipwhite nextgroup=vimSynRegion2
" syn region	vimSynRegion2	  contained keepend	matchgroup=vimGroupName start="\h\w*" skip="\\\\\|\\|" end="|\|$" contains=@vimSynRegGroup2
" syn match	vimSynRegOpt2	  contained	"\<\%(conceal\(ends\)\=\|transparent\|contained\|excludenl\|skipempty\|skipwhite\|display\|keepend\|oneline\|extend\|skipnl\|fold\)\>"
" syn match	vimSynReg2	  contained	"\%(start\|skip\|end\)="he=e-1	nextgroup=vimSynRegPat2
" syn match	vimSynMtchGrp2	  contained	"matchgroup="	nextgroup=vimGroup,vimHLGroup,vimOnlyHLGroup,nvimHLGroup
" syn region	vimSynRegPat2	  contained extend	start="\z([-`~!@#$%^&*_=+;:'",./?]\)\\v"  skip="\\\\\|\\\z1"  end="\z1"  contains=@vimSynRegPatGroup2 skipwhite nextgroup=vimSynPatMod2,vimSynReg2
" syn match	vimSynPatMod2	  contained	"\%(hs\|ms\|me\|hs\|he\|rs\|re\)=[se]\([-+]\d\+\)\="
" syn match	vimSynPatMod2	  contained	"\%(hs\|ms\|me\|hs\|he\|rs\|re\)=[se]\([-+]\d\+\)\=," nextgroup=vimSynPatMod2
" syn match	vimSynPatMod2	  contained	"lc=\d\+"
" syn match	vimSynPatMod2	  contained	"lc=\d\+," nextgroup=vimSynPatMod2
" syn region	vimSynPatRange2	  contained	start="\["	skip="\\\\\|\\]"   end="]"
" syn match	vimSynNotPatRange2  contained	"\\\\\|\\\["
" syn match	vimMtchComment2	  contained	'"[^"]\+$'
" syn cluster vimFuncBodyList add=vimSynType2
...
syn cluster	vimStringGroup	contains=vimEscapeBrace,vimPatSep,vimNotPatSep,vimPatSepErr,vimPatSepZone,@vimSubstSpecChars
" syn cluster	vimStringGroup	contains=vimEscapeBrace,vimPatSep,vimNotPatSep,vimPatSepErr,vimPatSepZone,vimEscapeBrace2,vimPatSep2,vimNotPatSep2,vimPatSepErr2,vimPatSepZone2,@Spell
...
hi def link vimSubstSpecChars2 PerlSpecialChar
hi def link vimSubstSpecChars3 SpecialChar


syn cluster	vimSubstList	contains=vimPatSep,vimPatRegion,vimPatSepErr,vimSubstTwoBS,vimSubstRange,vimNotation,@vimSubstSpecChars
...
syn region	vimCollection   contained transparent	start="\\\@<!\[" skip="\\\[" end="\]"	contains=vimCollClass,@vimSubstSpecChars matchgroup=PerlSpecialChar
...
" Syntax {{{2
"=======
syn match	vimGroupList	contained	"@\=[^ \t,]*"	contains=vimGroupSpecial,vimPatSep,vimPatSep2,@vimSubstSpecChars
syn match	vimGroupList	contained	"@\=[^ \t,]*,"	nextgroup=vimGroupList contains=vimGroupSpecial,vimPatSep,@vimSubstSpecChars
...
" " Syntax: region {{{2
syn cluster	vimSynRegPatGroup	contains=vimPatSep,vimNotPatSep,vimSynPatRange,vimSynNotPatRange,vimSubstSubstr,vimPatRegion,vimPatSepErr,vimNotation,@vimSubstSpecChars
